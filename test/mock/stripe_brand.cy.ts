describe('Successful Payment -  Cards by Brand', () => {
  (Cypress.env('testCards') as { type: string; number: string }[]).forEach(
    (card) => {
...
describe('Successful Payment -  Cards by CO-Brand', () => {
  (Cypress.env('testCoBrand') as { type: string; number: string }[]).forEach(
    (card) => {
      let paymentMethodId, transactionId;
...
describe('Successful Payment -  Cards by Brand', () => {
  (
    Cypress.env('testCardsRequiresAction') as { type: string; number: string }[]
  ).forEach((card) => {
    let paymentMethodId, transactionId;
