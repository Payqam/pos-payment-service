/**
 * MTN Payment Status Enum with priority values
 *
 * Each status has both a string value (for backward compatibility) and a numeric priority value.
 * The priority values can be used for comparison operations (e.g., if status > MTNPaymentStatus.PAYMENT_SUCCESSFUL)
 *
 * Priority grouping:
 * 1-3: Payment statuses
 * 4-7: Disbursement statuses
 * 8-10: Customer refund statuses
 * 11-13: Merchant refund statuses
 */
export enum MTNPaymentStatus {
  // Payment statuses (priority 1-3)
  PAYMENT_REQUEST_CREATED = 'PAYMENT_REQUEST_CREATED' as any as 1,
  PAYMENT_SUCCESSFUL = 'PAYMENT_SUCCESSFUL' as any as 2,
  PAYMENT_FAILED = 'PAYMENT_FAILED' as any as 3,

  // Disbursement statuses (priority 4-7)
  DISBURSEMENT_REQUEST_CREATED = 'DISBURSEMENT_REQUEST_CREATED' as any as 4,
  DISBURSEMENT_SUCCESSFUL = 'DISBURSEMENT_SUCCESSFUL' as any as 5,
  DISBURSEMENT_FAILED = 'DISBURSEMENT_FAILED' as any as 6,
  RETRYING_DISBURSEMENT = 'RETRYING_DISBURSEMENT' as any as 7,

  // Customer refund statuses (priority 8-10)
  CUSTOMER_REFUND_REQUEST_CREATED = 'CUSTOMER_REFUND_REQUEST_CREATED' as any as 8,
  CUSTOMER_REFUND_SUCCESSFUL = 'CUSTOMER_REFUND_SUCCESSFUL' as any as 9,
  CUSTOMER_REFUND_FAILED = 'CUSTOMER_REFUND_FAILED' as any as 10,

  // Merchant refund statuses (priority 11-13)
  MERCHANT_REFUND_REQUEST_CREATED = 'MERCHANT_REFUND_REQUEST_CREATED' as any as 11,
  MERCHANT_REFUND_SUCCESSFUL = 'MERCHANT_REFUND_SUCCESSFUL' as any as 12,
  MERCHANT_REFUND_FAILED = 'MERCHANT_REFUND_FAILED' as any as 13,
}
